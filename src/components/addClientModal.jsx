...
const SignupSchema = Yup.object().shape({
  ...
  email: Yup.string()
    ...
    .required("البريد الاكتروني مطلوب"),
});
const ClientModal = ({ show, setShow ,setUpdated }) => {
            ...
            >
              {({ errors, touched }) => (
                <Form>
                  ...
                  <button className="login-btn border-0 mt-3" type="submit">
                    اضافة عميل جديد
                  </button>
                </Form>
              )}
